  ...
  <footer id="footer">
    ...
    <n-flex :size="4" class="text" align="center" vertical>
      ...
      <n-p depth="3">
        ...
        <n-text depth="3" @click="jumpLink(linkData.home)"> TIANHU </n-text>
        <n-text
          v-if="siteIcp"
          depth="3"
...
const linkData = {
  github: "https://github.com/tianhukj/site-status",
  home: "https://tianhu.dpdns.org",
  email: "mailto:status@tianhu.dpdns.org",
};
</script>
